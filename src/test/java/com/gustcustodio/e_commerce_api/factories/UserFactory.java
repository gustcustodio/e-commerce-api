...
public class UserFactory {
    ...
    public static User createUserAdmin() {
        User user = new User(2L, "Valid Admin User", "441.766.180-43", "991234455", "admin@email.com", "$2a$10$VDNktmwwHMKRm8lUbdaHw.oYJbkU6hX3laW1pkyx7m7fb69QMdeJe");
    ...
    public static User createUserClient() {
        User user = new User(3L, "Valid Client User", "563.557.910-86", "991235566", "client@email.com", "$2a$10$VDNktmwwHMKRm8lUbdaHw.oYJbkU6hX3laW1pkyx7m7fb69QMdeJe");
